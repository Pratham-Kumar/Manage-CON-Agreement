		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage CON Agreement",
									"targetURL": "#comkpomanageconagreement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comkpomanageconagreement-display": {
								"semanticObject": "comkpomanageconagreement",
								"action": "display",
								"description": "Manage CON Agreement",
								"title": "Manage CON Agreement",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.kpo.manageconagreement",
									"url": sap.ui.require.toUrl("com/kpo/manageconagreement")
								}
							}
						}
					}
